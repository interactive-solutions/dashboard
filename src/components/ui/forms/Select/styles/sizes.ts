...
export const sizes: {
  ...
  small: (theme, size = {}) =>
    generateSize({
      ...size,
      minheight: '42px',
      controlTypograhy: theme.typography.body[10],
      controlBorderWidth: '2px',
      controlBorderRadius: theme.border.radius,
      valueContainerPadding: theme.spacing(0.25, 1.5),
      ...
      multiValueLabelPadding: theme.spacing(0.5, 0, 0.5, 1),
      ...
      optionTypography: theme.typography.body[10],
      optionPadding: theme.spacing(0.75, 1.5),
      messageTypography: theme.typography.body[10],
  ...
  medium: (theme, size = {}) =>
    generateSize({
      ...
      controlBorderWidth: '2px',
      controlBorderRadius: theme.border.radius,
      valueContainerPadding: theme.spacing(0.5, 2),
      indicatorSeparatorMarginTopAndBottom: theme.spacing(1.5),
      indicatorSeparatorWidth: '1px',
      multiValueBorderRadius: theme.border.radius,
      multiValueMargin: theme.spacing(0.25, 0.5, 0.25, 0),
      multiValueBorderWidth: '1px',
      ...
      optionPadding: theme.spacing(1, 2),
      messageTypography: theme.typography.body[20],
      messagePadding: theme.spacing(2)
    }),
  large: (theme, size = {}) =>
    generateSize({
      ...size,
      minheight: '62px',
      controlTypograhy: theme.typography.body[30],
      controlBorderWidth: '2px',
      controlBorderRadius: theme.border.radius,
      valueContainerPadding: theme.spacing(0.75, 2.5),
      indicatorSeparatorMarginTopAndBottom: theme.spacing(1.75),
      indicatorSeparatorWidth: '1px',
      multiValueBorderRadius: theme.border.radius,
      multiValueMargin: theme.spacing(0.25, 0.5, 0.25, 0),
      multiValueBorderWidth: '1px',
      ...
      optionTypography: theme.typography.body[30],
      optionPadding: theme.spacing(1.25, 2.5),
      messageTypography: theme.typography.body[30],
      messagePadding: theme.spacing(2.5)
    })
};
